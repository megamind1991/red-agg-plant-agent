...
public class MockClusterInvokerV2<T> implements Invoker<T> {

    private static final Logger logger = LoggerFactory.getLogger(MockClusterInvokerV2.class);

    private final Directory<T> directory;

    private final Invoker<T> invoker;

    public MockClusterInvokerV2(Directory<T> directory, Invoker<T> invoker) {
    ...
    public Result invoke(Invocation invocation) throws RpcException {
        ParameterUtils.printValueOnStack4Return(getUrl());
        Result result = null;
